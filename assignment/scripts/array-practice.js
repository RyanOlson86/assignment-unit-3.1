...
let favoriteFoods = [ 'pizza', 'burgers', 'mac and cheese', 'steak'];
...
console.log('Number of Favorite Food:', numberOfFoods);
...
console.log('The last animal using .length:',lastAnimal);
...
console.log('Favorit food update:',favoriteFoods);
...
console.log('Favorit food new entree:',favoriteFoods);
...
gems[1] = 'Tourmaline';
console.log('Changed 2nd gem Citrine to:', gems[1]);
console.log('The gems are:', gems);

// 5.b (STRETCH) TODO: Sort your gems array in reverse alphabetical order.
//     Please console.log the sorted array.
gems.sort();
console.log("Alphabetical order:", gems);
gems.reverse();
console.log("Reverse alpha order:", gems);
